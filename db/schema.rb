...
ActiveRecord::Schema[7.0].define(version: 20_220_601_050_619) do
  ...
  create_table 'log_items', force: :cascade do |t|
    ...
    t.index %w[vehicle_id performed_at], name: 'index_log_items_on_vehicle_id_and_performed_at'
  ...
  create_table 'odometer_readings', force: :cascade do |t|
    ...
    t.index %w[vehicle_id performed_at], name: 'index_odometer_readings_on_vehicle_id_and_performed_at'
