...
class TireSetsTest < ApplicationSystemTestCase
  ...
  test 'visiting the index' do
    visit tire_sets_url
    assert_selector 'h1', text: 'My tire sets'
  end
  ...
  test 'should create tire set' do
    ...
    fill_in 'Break-in period', with: @tire_set.breakin
    ...
    fill_in 'Display name', with: @tire_set.user_display_name
  ...
  test 'should update Tire set' do
    ...
    click_on 'Edit Tires', match: :first
  ...
  test 'should destroy Tire set' do
    ...
    visit tire_set_url(@tire_set)
    click_on 'Destroy Tires', match: :first
