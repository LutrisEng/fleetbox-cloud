class TireSetsController < ApplicationController
  ...
  private
    ...
    def tire_set_params
      params.require(:tire_set).permit(:aspect_ratio, :base_miles, :breakin, :construction, :diameter, :hidden, :load_index, :make, :model, :speed_rating, :tin, :user_display_name, :vehicle_type, :width)
    end
end
